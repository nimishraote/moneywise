        ...
        <div className="relative px-6 py-14 md:px-10 md:py-16 lg:px-14 lg:py-20">
          <div className="mx-auto max-w-5xl">
            ...
            <p className="mt-7 max-w-3xl text-xl leading-9 text-slate-300">
              MoneyWise is for young adults who want to understand money before life gets more
              expensive and more complicated. It turns stress, confusion, and avoidance into clearer
              choices, better habits, and practical next steps.
            </p>
            ...
            <div className="mt-8 max-w-4xl rounded-[28px] border border-white/10 bg-[linear-gradient(135deg,rgba(255,255,255,0.08)_0%,rgba(196,181,253,0.05)_100%)] p-6 shadow-2xl backdrop-blur">
              <div className="grid gap-4 md:grid-cols-3">
                <div className="rounded-[22px] border border-white/10 bg-white/5 px-5 py-5">
                  <div className="text-sm font-semibold text-white">Understand what is happening</div>
                ...
                <div className="rounded-[22px] border border-white/10 bg-white/5 px-5 py-5">
                  <div className="text-sm font-semibold text-white">Get a plan shaped around you</div>
                  <div className="mt-2 text-sm leading-6 text-slate-300">
                ...
                <div className="rounded-[22px] border border-white/10 bg-white/5 px-5 py-5">
                  <div className="text-sm font-semibold text-white">Build confidence over time</div>
                  <div className="mt-2 text-sm leading-6 text-slate-300">
