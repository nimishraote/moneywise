...
Your job:
Write a personalized summary for the user's "starting plan" page based only on their assessment answers.
...
- do not invent facts not present in the assessment
